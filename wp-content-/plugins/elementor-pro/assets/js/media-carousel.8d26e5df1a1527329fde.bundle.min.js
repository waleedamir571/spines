            ...
            class MediaCarousel extends n.default {
                ...
                getDefaultElements(...e) {
                    const t = this.getSettings("selectors"),
                        i = super.getDefaultElements(...e);
                    return this.isSlideshow() && (i.$thumbsSwiper = this.$element.find(t.thumbsSwiper)), i
                }
                getEffect() {
                ...
                async onInit() {
                    ...
                    "yes" === t.lazyload && (o.lazy = {
                        loadPrevNext: !0,
                        loadPrevNextAmount: 1
                    });
                    const l = elementorFrontend.utils.swiper;
                    this.swiper.controller.control = this.thumbsSwiper = await new l(this.elements.$thumbsSwiper, o), this.elements.$thumbsSwiper.data("swiper", this.thumbsSwiper), this.thumbsSwiper.controller.control = this.swiper
                }
            }
