...
(self.webpackChunkelementorFrontend = self.webpackChunkelementorFrontend || []).push([
    [304, 915], {
        ...
        7469: (e, t, i) => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.default = void 0, i(4846), i(7458), i(6211);
            var s = n(i(7224));
        ...
        8216: (e, t, i) => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.default = void 0, i(4846), i(6211), i(9655);
            var s = n(i(7224)),
                o = n(i(1616));
            class NestedAccordion extends s.default {
                constructor(...e) {
                    super(...e), this.animations = new Map
                }
                getDefaultSettings() {
                    return {
                        selectors: {
                ...
                onInit(...e) {
                    super.onInit(...e), this.injectKeyboardHandler()
                }
                ...
                linkContainer(e) {
                    ...
                    if (t.model.get("id") === this.$element.data("id")) {
                        ...
                        void 0 !== t && t.appendChild(r), this.updateIndexValues(), this.updateListeners(o), elementor.$preview[0].contentWindow.dispatchEvent(new CustomEvent("elementor/elements/link-data-bindings"))
                    }
                }
                move(e, t, i, n) {
                ...
                updateIndexValues() {
                    const {
                        $accordionContent: e,
                        $accordionItems: t
                    } = this.getDefaultElements(), i = this.getSettings(), n = t[0].getAttribute("id").slice(0, -1);
                    t.each((t, s) => {
                ...
                clickListener(e) {
                    ...
                    const t = this.getSettings(),
                        ...
                        {
                            max_items_expended: r
                        } = this.getElementSettings(),
                        a = n.querySelectorAll(t.selectors.directAccordionItems),
                        l = n.querySelectorAll(t.selectors.directAccordionItemTitles);
                    "one" === r && this.closeAllItems(a, l), i.open ? this.closeAccordionItem(i, s) : this.prepareOpenAnimation(i, s, o)
                }
                animateItem(e, t, i, n) {
                    ...
                    }), s.onfinish = () => this.onAnimationFinish(e, n), this.animations.set(e, s), e.querySelector("summary") ? .setAttribute("aria-expanded", n)
                }
