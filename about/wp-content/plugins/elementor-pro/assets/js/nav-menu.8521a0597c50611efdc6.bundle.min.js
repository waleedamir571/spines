    ...
    [334], {
        3556: (e, t) => {
            ...
            t.default = class AnchorLinks {
                observer = null;
                constructor(e, t) {
                    this.$anchorLinks = e, this.activeAnchorClass = t.activeAnchorItem, this.anchorClass = t.anchorItem
                }
                getViewportHeight() {
                ...
                initialize() {
                    this.viewPortHeight = this.getViewportHeight(), this.followMenuAnchors(), this.bindEvents()
                }
                followMenuAnchors() {
                ...
                followMenuAnchor(e) {
                    ...
                    this.observer = this.createObserver(t, e, i), this.observer.observe(n)
                }
                getAnchorElement(e) {
                    const t = e[0].hash;
                    try {
                ...
                createObserver(e, t, n) {
                    return new IntersectionObserver((n => {
                        n.forEach((n => {
                            e.toggleClass(this.activeAnchorClass, n.isIntersecting), t.attr("aria-current", n.isIntersecting ? "location" : "")
                        }))
                    }), n)
                }
                onResize() {
                    this.viewPortHeight = this.getViewportHeight(), this.observer && this.observer.disconnect(), this.followMenuAnchors()
                }
            }
        },
        757: (e, t, n) => {
            ...
            t.default = elementorModules.frontend.handlers.Base.extend({
                ...
                onInit() {
                    ...
                    let t = "";
                    if (e && (t = e.indexOf("<") > -1 ? e : `<i class="${e}" aria-hidden="true"></i>`), this.elements.$menu.smartmenus({
                            subIndicators: "" !== t,
                            subIndicatorsText: t,
                        ...
                        this.anchorLinks = new s.default(this.elements.$anchorLink, e), this.anchorLinks.initialize()
                    }
                },
                onElementChange(e) {
